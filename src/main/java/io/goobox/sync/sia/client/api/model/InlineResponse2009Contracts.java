...
public class InlineResponse2009Contracts {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(downloadspending, endheight, fees, hostpublickey, id, lasttransaction, netaddress, renterfunds, size, startheight, storagespending, totalcost, uploadspending, goodforupload, goodforrenew);
  }
