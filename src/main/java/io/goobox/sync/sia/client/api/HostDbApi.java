...
public class HostDbApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse2006 hostdbHostsPubkeyGet(String pubkey) throws ApiException {
        ApiResponse<InlineResponse2006> resp = hostdbHostsPubkeyGetWithHttpInfo(pubkey);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse2006> hostdbHostsPubkeyGetWithHttpInfo(String pubkey) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call hostdbHostsPubkeyGetAsync(String pubkey, final ApiCallback<InlineResponse2006> callback) throws ApiException {
