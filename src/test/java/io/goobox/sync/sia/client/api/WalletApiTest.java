...
public class WalletApiTest {
    ...
    public void walletAddressGetTest() throws ApiException {
        InlineResponse20014 response = api.walletAddressGet();
    ...
    public void walletAddressesGetTest() throws ApiException {
        InlineResponse20015 response = api.walletAddressesGet();
    ...
    public void walletGetTest() throws ApiException {
        InlineResponse20013 response = api.walletGet();
    ...
    public void walletInitPostTest() throws ApiException {
        ...
        Boolean force = null;
        InlineResponse20016 response = api.walletInitPost(encryptionpassword, dictionary, force);
    ...
    public void walletSeedsGetTest() throws ApiException {
        String dictionary = null;
        InlineResponse20017 response = api.walletSeedsGet(dictionary);
    ...
    public void walletSiacoinsPostTest() throws ApiException {
        ...
        String destination = null;
        String outputs = null;
        InlineResponse20018 response = api.walletSiacoinsPost(amount, destination, outputs);
    ...
    public void walletSiafundsPostTest() throws ApiException {
        Integer amount = null;
        String destination = null;
        InlineResponse20018 response = api.walletSiafundsPost(amount, destination);
    ...
    public void walletSweepSeedPostTest() throws ApiException {
        String dictionary = null;
        String seed = null;
        InlineResponse20019 response = api.walletSweepSeedPost(dictionary, seed);
    ...
    public void walletTransactionIdGetTest() throws ApiException {
        String id = null;
        InlineResponse20020 response = api.walletTransactionIdGet(id);
    ...
    public void walletTransactionsAddrGetTest() throws ApiException {
        String addr = null;
        InlineResponse20022 response = api.walletTransactionsAddrGet(addr);
    ...
    public void walletTransactionsGetTest() throws ApiException {
        ...
        InlineResponse20021 response = api.walletTransactionsGet(startheight, endheight);
    ...
    public void walletVerifyAddressAddrGetTest() throws ApiException {
        String addr = null;
        InlineResponse20023 response = api.walletVerifyAddressAddrGet(addr);
